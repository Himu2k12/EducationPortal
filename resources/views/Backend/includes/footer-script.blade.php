...
<script>
    ...
    function getMemberInfo(id){
        ...
        $.ajax({
            ...
            $('#paymentAmount').append('Amount: ৳ <b> '+myArray[0].amount_of_money+'</b><hr>');
            $('#applicantPhoto').append(' <img src="'+myArray[0].applicant_photo+'"alt="" class="img-rounded img-responsive"/>');
    ...
    function withdrawInfo(id){
        ...
        $.ajax({
            ...
            $('#savingsMoney').append('Savings Amount: <b>'+myArray[2]+'</b>');
